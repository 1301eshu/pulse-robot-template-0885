      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-start">
        ...
        <div>
          ...
          <p className="text-gray-700 mb-6 text-base leading-relaxed">
           We’re here to spark smarter, more meaningful growth
            We want to be a melting pot
           for our clients, our people, and our world. Powered by technology, driven by creativity, and grounded in empathy, we believe in building lasting momentum by always{" "}
