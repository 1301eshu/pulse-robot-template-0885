...
const RecentResourcesSection: React.FC = () => {
  ...
  const body =
    "Dive into our treasure trove of DIY checklists designed to make your tech tasks a breeze.";
            ...
            >
              <Card className="bg-white overflow-hidden transition-all group cursor-pointer hover:shadow-xl border border-gray-100">
                ...
                <CardContent className="bg-white p-6">
                  ...
                  {/* If you want subtitle/readTime back, un-comment below */}
                  {/* <p className="text-gray-700 line-clamp-2">{resource.subtitle}</p>
