    ...
    <footer role="contentinfo" className="bg-[#06080C] text-white text-sm">
      ...
      <div className="max-w-7xl mx-auto px-4 py-12 grid grid-cols-1 md:grid-cols-12 gap-y-8 md:gap-x-12">
        ...
        <div className="md:col-span-2">
          ...
          <ul className="space-y-1">
            <li>
              <a
                href="/marketing-automation-services/"
                className="text-white no-underline hover:text-blue-600 hover:underline hover:decoration-blue-600 transition"
              >
            ...
            <li>
              <a
                href="/marketing-analytics-services/"
                className="text-white no-underline hover:text-blue-600 hover:underline hover:decoration-blue-600 transition"
              >
                Marketing Analytics
              </a>
            ...
            <li>
              <a
                href="/jira-professional-services/"
                className="text-white no-underline hover:text-blue-600 hover:underline hover:decoration-blue-600 transition"
              >
        ...
        <div className="md:col-span-3">
          ...
          <div className="flex gap-2 mt-4">
            <img
              src="https://jhtpqlptodpdsixlblpx.supabase.co/storage/v1/object/public/media/Mega%20Menu/Footer/iso-certified-logo.webp"
              alt="ISO"
              className="h-6"
            />
            <img
              src="https://jhtpqlptodpdsixlblpx.supabase.co/storage/v1/object/public/media/Mega%20Menu/Footer/privacy-iso-certified-logo.webp"
              alt="ISO"
              className="h-6"
            />
            <img
              src="https://jhtpqlptodpdsixlblpx.supabase.co/storage/v1/object/public/media/Mega%20Menu/Footer/Logo-gdpr.webp"
              alt="GDPR"
              className="h-6"
            />
            <img
              src="https://jhtpqlptodpdsixlblpx.supabase.co/storage/v1/object/public/media/Mega%20Menu/Footer/hipaa-compliant.webp"
              alt="HIPAA"
              className="h-6"
            />
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-4 flex flex-col md:flex-row justify-between items-center text-xs">
        <div className="flex gap-4 flex-wrap text-gray-400">
          ...
          <li>
            <a
              href="/resources/editorial-policy/"
              className="text-white no-underline hover:text-blue-600 hover:underline hover:decoration-blue-600 transition"
            >
              Editorial Policy
            </a>
        ...
        <div className="flex gap-2 ">
          <a
            ...
            rel="noopener noreferrer"
          >
           <img src ="https://images.dmca.com/Badges/dmca_protected_sml_120m.png?ID=2c70a2b9-64c1-4bf8-86e2-2cf6b0552ec7"  alt="DMCA.com Protected" className="h-6" />
          </a>
        </div>
