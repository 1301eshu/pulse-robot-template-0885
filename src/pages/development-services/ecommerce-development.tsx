...
export default function MarketingAutomation() {
 ...
 //     ctaLink: "/lead-gen-form"
  ...
  const features: FeatureContent[] = [
    {
      id: "shopify",
      description: "Your store shouldnt feel like everyone elses. We design it in a way that it flexes with every integration your stack throws at it.",
      items: [
    ...
    },
    {
      ...
      items: [
        { icon: BarChart2, title: "Complex needs? Weve got the Magento magic" },
