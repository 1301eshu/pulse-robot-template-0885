...
export default function DevOpsAutomation() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: "With agile practices and automation, DevOps scales seamlessly whether youre a startup or an enterprise.",
    },
  ];
    ...
    <div className="bg-white text-gray-900">
      ...
      <main className="pt-0">
        ...
        <EditableStatSection
          ...
          title="Youre in good company where speed, seamless releases, and brand success unite"
          stats={[
