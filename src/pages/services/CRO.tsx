    ...
    <div className="bg-white text-gray-900">
      ...
      <main className="">
        ...
        <HeroSection
          ...
          rightImage="https://jhtpqlptodpdsixlblpx.supabase.co/storage/v1/object/public/media/Mega%20Menu/DigitalMarketing/Hero%20Section_L2_Bannera/CRO.webp"
          buttonText={heroCta}
        />
