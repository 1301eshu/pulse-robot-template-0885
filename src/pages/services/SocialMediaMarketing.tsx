 ...
 const tabs: TabItem[] = [
  {
    ...
    icon: Zap,
    image: "https://jhtpqlptodpdsixlblpx.supabase.co/storage/v1/object/public/media/Mega%20Menu/DigitalMarketing/Social%20Media%20Marketing%20/Linkedin%20Marketing.webp", // replace with actual
   ctaText: "Read More",
     ctaLink: "L3/smm-linkedin"
  },
  {
    id: "analytics",
  ...
  stats={[
    ...
    { label: "Faster turnarounds via AI-assisted content workflows ", value: "30%" },
        ...
        <RecentResourcesSection
          ...
          body="See how we turned their likes into loyalty, and followers into funnels."
          subTabs={[]}
