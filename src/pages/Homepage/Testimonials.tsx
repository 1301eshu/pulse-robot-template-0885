...
const testimonials: Testimonial[] = [
  {
    quote:
      "qwertyuioplkjhgfdsxcvbnjiuytrd",
...
export default function Testimonials({ title = " Real Stories. Real Growth.", description = " What it's like to work with a team that actually builds with you." }: TestimonialsProps) {
