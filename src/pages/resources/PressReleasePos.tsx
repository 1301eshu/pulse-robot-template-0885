...
useEffect(() => {
  ...
  if (notFound) return <Navigate to="/infographics" replace />;
  ...
  const postCategory = post._embedded?.["wp:term"]?.[0]?.[0]?.name || "Infographics";
    ...
    <div className="bg-white">
      ...
      <main className="pt-12 px-4 sm:px-6">
        <div className="max-w-[1140px] mx-auto">
          ...
          <section className="pt-24 pb-24 grid md:grid-cols-2 gap-10 items-start   mb-20">
            <div>
              <Link to="/infographics" className="text-blue-600 text-sm flex items-center gap-1 mb-6 hover:underline">
                <ArrowLeft className="w-4 h-4" />
